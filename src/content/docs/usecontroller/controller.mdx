...
| `fieldState`                           | `isValidating`       | <TypeText>boolean</TypeText>                | Validation state for current controlled input.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `formState`                            | `validatingFields`   | <TypeText>object</TypeText>                 | An object containing all the inputs on which validation was triggered.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
